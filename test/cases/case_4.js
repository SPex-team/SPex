...
const ACCOUNT_INIT_BALANCE = 100000000000000000000000000000n; // 1e29
...
const CASE = {
  ...
  stepList: [
    ...
    {
      increaseBlockNumber: 34000,
      contractName: "spexBeneficiary",
      functionName: "batchDirectRepayment",
      params: [["__signer3", "__signer4"], [10323231, 10323231], [ONE_ETHER * 2n, ONE_ETHER * 3n]],
      value: BigInt(5n * ONE_ETHER),
      signerIndex: 1,
    },
  ],
  finalStateCheckList: [
    {
      ...
      results: {
        ...
        disabled: false,
        principalAmount: 18651298020479599346n,
        maxLenderCount: 10n,
    ...
    },
    {
      ...
      signerIndex: 0,
      results: {
        principalAmount: 1230410360350354886n,
        lastAmount: 1230410360350354886n,
        lastUpdateTime: HARDHAT_INIT_TIMESTAMP + (34000 + 184923 + 43812 + 3434 + 343 + 3) * 30
      },
    },
    {
      increaseBlockNumber: 1023,
      ...
      signerIndex: 0,
      results: {
        principalAmount: 17420887660129244460n,
        lastAmount: 17420887660129244460n,
        lastUpdateTime: HARDHAT_INIT_TIMESTAMP + (34000 + 184923 + 43812 + 3434 + 343 + 3) * 30
      },
    },
    {
  ...
  finalBalanceCheckList: [
    {
        ...
        contractName: "spexBeneficiary",
        accountIndex: 0,
        expectBalance: 65129802047959933n
    },
    {
        accountType: "owned",
        contractName: "",
        accountIndex: 1,
        expectBalance: ACCOUNT_INIT_BALANCE - 7n * ONE_ETHER - 5n * ONE_ETHER
    },
    {
        accountType: "owned",
        contractName: "",
    ...
    },
    {
        ...
        contractName: "",
        accountIndex: 3,
        expectBalance: ACCOUNT_INIT_BALANCE - 10n * ONE_ETHER + 7n * ONE_ETHER - 21997880401492022n + 2n * ONE_ETHER - 1043155633543424n,
    ...
    },
    {
        ...
        contractName: "",
        accountIndex: 4,
        expectBalance: ACCOUNT_INIT_BALANCE - 20n * ONE_ETHER + 3n * ONE_ETHER - 42088766012924314n,
        tolaranceRange: 1e-16
    },
    {
        accountType: "owned",
