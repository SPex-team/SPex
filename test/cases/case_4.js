  ...
  finalStateCheckList: [
    {
      ...
      results: {
        ...
        disabled: false,
        principalAmount: 23n * ONE_ETHER + 219978804014920227n - 5n * ONE_ETHER + 75224258215505920n,
        maxLenderCount: 10n,
    ...
    },
    {
      ...
      signerIndex: 0,
      results: {
        principalAmount: 3n * ONE_ETHER + 219978804014920227n - 2n * ONE_ETHER + 10431556335434240n,
        lastAmount: 3n * ONE_ETHER + 219978804014920227n + 10431556335434240n - 2n * ONE_ETHER,
    ...
    },
    {
      ...
      signerIndex: 0,
      results: {
        principalAmount: 20n * ONE_ETHER + 420887660129243140n - 3n * ONE_ETHER,
        lastAmount: 20n * ONE_ETHER + 420887660129243140n - 3n * ONE_ETHER,
        lastUpdateTime: HARDHAT_INIT_TIMESTAMP + (34000 + 184923 + 43812 + 3434 + 343 + 3) * 30
      },
    },
    {
